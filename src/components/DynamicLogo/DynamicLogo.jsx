...
const DynamicLogo = () => {
  return (
    ...
    >
      ...
      <path
        fill="none"
        d="M278.784 120.768c.106-.451 6.541-34.17 14.3-74.928 7.76-40.76 14.227-74.717 14.372-75.462l.264-1.355 29.55 24.626 29.55 24.626-9.798 7.89c-5.39 4.339-9.895 7.889-10.013 7.889-.117 0-6.43-4.836-14.026-10.746-11.798-9.179-13.853-10.651-14.086-10.09-.44 1.06-11.745 53.806-11.635 54.285.056.24 8.99-6.717 19.853-15.459 10.863-8.741 19.891-15.843 20.062-15.781.171.062 4.248 3.166 9.06 6.898 6.515 5.052 8.643 6.886 8.331 7.177-.23.215-16.893 14.03-37.027 30.7-20.133 16.67-39.384 32.614-42.779 35.43-4.528 3.758-6.12 4.903-5.978 4.3z"
      />
      <path
        fill="url(#c)"
        stroke="#232323"
